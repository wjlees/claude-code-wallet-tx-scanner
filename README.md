...
└── modules/
    ...
    └── tx-scanner/                  # 핵심: 무한 루프 주체 + tx 감지 + 저장
        ...
        ├── unspents.repository.ts    # crypto_address_unspents(UTXO 원장, §17) 인터페이스 + in-memory stub — 잔고 SUM/vin 출금탐지
